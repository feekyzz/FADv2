...
# Conv2d.register_module('AdaDilatedConv')
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.cv2 = AdaptiveDilatedConv(c_,c2,3)
...
if __name__ == '__main__':
    x = torch.rand(1, 8, 1, 1).cuda()
    m = FADCBlock(c1=8, c2=16).cuda()
    m.eval()
    y = m(x)
    print(y.shape)